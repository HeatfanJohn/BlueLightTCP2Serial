...
def update_display(this_surface, this_light_state):
    ...
    font_sm = pygame.font.Font(None, 50)
    font_md = pygame.font.Font(None, 75)
    font_lg = pygame.font.Font(None, 125)
